...
export type ParseRunParams =
  | ParseRunParams.ParseConfig
  | ParseRunParams.ParseConfig
  | ParseRunParams.SyncParseConfig;
...
export type ParseRunJobParams = ParseRunJobParams.AsyncParseConfigNew | ParseRunJobParams.AsyncParseConfig;

export declare namespace ParseRunJobParams {
  export interface AsyncParseConfigNew {
    /**
     * The URL of the document to be processed. You can provide one of the following:
     *
     * 1. A publicly available URL
