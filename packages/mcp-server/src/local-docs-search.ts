...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    response:
      "{ result: { section_mapping: object; splits: { name: string; pages: number[]; conf?: 'high' | 'low'; partitions?: object[]; }[]; } | { splits: { name: string; pages: deep_split_page_evidence[]; partitions?: object[]; }[]; }; usage: { num_pages: number; credit_breakdown?: object; credits?: number; page_billing_breakdown?: object; }; response_type?: 'split'; }",
    markdown:
  ...
  },
  {
    ...
    response:
      "{ document_url: string; form_schema?: { bbox: bounding_box; description: string; type: 'text' | 'checkbox' | 'radio' | 'dropdown' | 'barcode'; fill?: boolean; font_size?: number; value?: string; }[]; response_type?: 'edit'; usage?: { num_pages: number; credit_breakdown?: object; credits?: number; page_billing_breakdown?: object; }; }",
    markdown:
  ...
  },
  {
    ...
    response:
      "{ job_id: string; result: { extract: { page_range: number[]; result: extract_response | v3_extract; split_name: string; partition?: string; }[] | object | object; parse: object | object[]; split: object; edit?: object; }; usage: { num_pages: number; credit_breakdown?: object; credits?: number; page_billing_breakdown?: object; }; response_type?: 'pipeline'; }",
    markdown:
