...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    params: [
      ...
      "parsing?: { enhance?: { agentic?: table_agentic | figure_agentic | text_agentic[]; intelligent_ordering?: boolean; summarize_figures?: boolean; }; formatting?: { add_page_markers?: boolean; include?: 'change_tracking' | 'highlight' | 'comments' | 'hyperlinks' | 'signatures' | 'ignore_watermarks'[]; merge_tables?: boolean; table_output_format?: 'html' | 'json' | 'md' | 'jsonbbox' | 'dynamic' | 'csv'; }; retrieval?: { chunking?: chunking; embedding_optimized?: boolean; filter_blocks?: string[]; }; settings?: { document_password?: string; embed_pdf_metadata?: boolean; embed_pdf_metadata_dpi?: number; extraction_mode?: 'ocr' | 'hybrid'; force_file_extension?: string; force_url_result?: boolean; hybrid_vpc?: object; ocr_system?: 'standard' | 'legacy'; page_range?: page_range | page_range[] | number[] | string[]; persist_results?: boolean; return_images?: 'figure' | 'table' | 'page'[]; return_ocr_data?: boolean; tenant_throttling?: object; timeout?: number; }; spreadsheet?: { clustering?: 'accurate' | 'fast' | 'disabled'; exclude?: 'hidden_sheets' | 'hidden_rows' | 'hidden_cols' | 'styling' | 'spreadsheet_images'[]; include?: 'cell_colors' | 'formula' | 'dropdowns'[]; max_cell_count?: number; split_large_tables?: split_large_tables; }; };",
      "settings?: { allow_page_overlap?: boolean; deep_split?: boolean; force_url_result?: boolean; table_cutoff?: 'truncate' | 'preserve'; };",
      'split_rules?: string;',
    ],
    response:
