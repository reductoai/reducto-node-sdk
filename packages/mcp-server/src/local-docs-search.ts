...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    params: [
      "{ input: string | string[] | { file_id: string; presigned_url?: string; }; enhance?: { agentic?: object | object | object[]; intelligent_ordering?: boolean; summarize_figures?: boolean; }; formatting?: { add_page_markers?: boolean; include?: 'change_tracking' | 'highlight' | 'comments' | 'hyperlinks' | 'signatures' | 'ignore_watermarks'[]; merge_tables?: boolean; table_output_format?: 'html' | 'json' | 'md' | 'jsonbbox' | 'dynamic' | 'csv'; }; retrieval?: { chunking?: object; embedding_optimized?: boolean; filter_blocks?: string[]; }; settings?: { document_password?: string; embed_pdf_metadata?: boolean; embed_pdf_metadata_dpi?: number; extraction_mode?: 'ocr' | 'hybrid'; force_file_extension?: string; force_url_result?: boolean; hybrid_vpc?: { environment?: string; }; ocr_system?: 'standard' | 'legacy'; page_range?: object | object[] | number[] | string[]; persist_results?: boolean; return_images?: 'figure' | 'table' | 'page'[]; return_ocr_data?: boolean; timeout?: number; }; spreadsheet?: { clustering?: 'accurate' | 'fast' | 'disabled'; exclude?: 'hidden_sheets' | 'hidden_rows' | 'hidden_cols' | 'styling' | 'spreadsheet_images'[]; include?: 'cell_colors' | 'formula' | 'dropdowns'[]; max_cell_count?: number; split_large_tables?: object; }; } | { input: string | string[] | { file_id: string; presigned_url?: string; }; async?: { metadata?: object; priority?: boolean; webhook?: svix_webhook_config | direct_webhook_config; }; enhance?: { agentic?: table_agentic | figure_agentic | text_agentic[]; intelligent_ordering?: boolean; summarize_figures?: boolean; }; formatting?: { add_page_markers?: boolean; include?: 'change_tracking' | 'highlight' | 'comments' | 'hyperlinks' | 'signatures' | 'ignore_watermarks'[]; merge_tables?: boolean; table_output_format?: 'html' | 'json' | 'md' | 'jsonbbox' | 'dynamic' | 'csv'; }; queue_priority?: 'auto' | 'standard' | 'batch'; retrieval?: { chunking?: chunking; embedding_optimized?: boolean; filter_blocks?: string[]; }; settings?: { document_password?: string; embed_pdf_metadata?: boolean; embed_pdf_metadata_dpi?: number; extraction_mode?: 'ocr' | 'hybrid'; force_file_extension?: string; force_url_result?: boolean; hybrid_vpc?: object; ocr_system?: 'standard' | 'legacy'; page_range?: page_range | page_range[] | number[] | string[]; persist_results?: boolean; return_images?: 'figure' | 'table' | 'page'[]; return_ocr_data?: boolean; timeout?: number; }; spreadsheet?: { clustering?: 'accurate' | 'fast' | 'disabled'; exclude?: 'hidden_sheets' | 'hidden_rows' | 'hidden_cols' | 'styling' | 'spreadsheet_images'[]; include?: 'cell_colors' | 'formula' | 'dropdowns'[]; max_cell_count?: number; split_large_tables?: split_large_tables; }; };",
    ],
    response:
  ...
  },
  {
    ...
    params: [
      ...
      "settings?: { document_password?: string; embed_pdf_metadata?: boolean; embed_pdf_metadata_dpi?: number; extraction_mode?: 'ocr' | 'hybrid'; force_file_extension?: string; force_url_result?: boolean; hybrid_vpc?: { environment?: string; }; ocr_system?: 'standard' | 'legacy'; page_range?: { end?: number; start?: number; } | { end?: number; start?: number; }[] | number[] | string[]; persist_results?: boolean; return_images?: 'figure' | 'table' | 'page'[]; return_ocr_data?: boolean; timeout?: number; };",
