...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    params: [
      ...
      "enhance?: { agentic?: { scope: 'table'; mode?: 'default' | 'auto' | 'max'; prompt?: string; } | { scope: 'figure'; advanced_chart_agent?: boolean; prompt?: string; return_overlays?: boolean; } | { scope: 'text'; prompt?: string; }[]; intelligent_ordering?: boolean; summarize_figures?: boolean; };",
