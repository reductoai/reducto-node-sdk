...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    params: [
      ...
      "settings?: { array_extract?: boolean; citations?: { enabled?: boolean; numerical_confidence?: boolean; parent_block?: 'full' | 'bbox_only'; }; deep_extract?: boolean; include_images?: boolean; optimize_for_latency?: boolean; };",
    ],
    response: '{ job_id: string; }',
    markdown:
  ...
  },
  {
    ...
    markdown:
      "## run\n\n`client.pipeline.run(input: string | string[] | { file_id: string; presigned_url?: string; }, pipeline_id: string, settings?: { document_password?: string; }): { job_id: string; result: object; usage: parse_usage; response_type?: 'pipeline'; }`\n\n**post** `/pipeline`\n\nPipeline\n\n### Parameters\n\n- `input: string | string[] | { file_id: string; presigned_url?: string; }`\n  For parse/split/extract pipelines, the URL of the document to be processed. You can provide one of the following:\n            1. A publicly available URL\n            2. A presigned S3 URL\n            3. A reducto:// prefixed URL obtained from the /upload endpoint after directly uploading a document\n            4. A jobid:// prefixed URL obtained from a previous /parse invocation\n            5. A list of URLs (for multi-document pipelines, V3 API only)\n\n            For edit pipelines, this should be a string containing the edit instructions \n\n- `pipeline_id: string`\n  The ID of the pipeline to use for the document.\n\n- `settings?: { document_password?: string; }`\n  Settings for pipeline execution that override pipeline defaults.\n  - `document_password?: string`\n    Password to decrypt password-protected documents.\n\n### Returns\n\n- `{ job_id: string; result: { extract: { page_range: number[]; result: extract_response | v3_extract; split_name: string; partition?: string; }[] | object | object; parse: object | object[]; split: object; edit?: object; }; usage: { num_pages: number; credit_breakdown?: object; credits?: number; non_empty_cell_count?: number; page_billing_breakdown?: object; }; response_type?: 'pipeline'; }`\n\n  - `job_id: string`\n  - `result: { extract: { page_range: number[]; result: object | object; split_name: string; partition?: string; }[] | object | object; parse: { duration: number; job_id: string; result: { chunks: object[]; type: 'full'; custom?: object; ocr?: object; } | { result_id: string; type: 'url'; url: string; }; usage: object; parse_mode?: 'base' | 'lite'; pdf_url?: string; response_type?: 'parse'; studio_link?: string; } | { duration: number; job_id: string; result: { chunks: object[]; type: 'full'; custom?: object; ocr?: object; } | { result_id: string; type: 'url'; url: string; }; usage: object; parse_mode?: 'base' | 'lite'; pdf_url?: string; response_type?: 'parse'; studio_link?: string; }[]; split: { result: { section_mapping: object; splits: object[]; } | { splits: object[]; }; usage: object; response_type?: 'split'; }; edit?: { document_url: string; form_schema?: object[]; response_type?: 'edit'; usage?: object; }; }`\n  - `usage: { num_pages: number; credit_breakdown?: object; credits?: number; non_empty_cell_count?: number; page_billing_breakdown?: object; }`\n  - `response_type?: 'pipeline'`\n\n### Example\n\n```typescript\nimport Reducto from 'reductoai';\n\nconst client = new Reducto();\n\nconst pipelineResponse = await client.pipeline.run({ input: 'string', pipeline_id: 'pipeline_id' });\n\nconsole.log(pipelineResponse);\n```",
  },
  {
    name: 'run_job',
  ...
  },
  {
    ...
    markdown:
      "## get\n\n`client.job.get(job_id: string): { status: 'Pending' | 'Completed' | 'Failed' | 'Idle'; progress?: number; reason?: string; result?: parse_response | extract_response | split_response | edit_response | pipeline_response | v3_extract | classify_response; } | { status: 'Pending' | 'Completed' | 'Failed' | 'Idle'; bucket?: object; created_at?: string; duration?: number; num_pages?: number; progress?: number; raw_config?: string; reason?: string; result?: parse_response | extract_response | split_response | edit_response | pipeline_response | v3_extract | classify_response; source?: object; total_pages?: number; type?: 'Parse' | 'Extract' | 'Split' | 'Edit' | 'Pipeline' | 'Classify'; }`\n\n**get** `/job/{job_id}`\n\nRetrieve Parse\n\n### Parameters\n\n- `job_id: string`\n\n### Returns\n\n- `{ status: 'Pending' | 'Completed' | 'Failed' | 'Idle'; progress?: number; reason?: string; result?: { duration: number; job_id: string; result: object | object; usage: parse_usage; parse_mode?: 'base' | 'lite'; pdf_url?: string; response_type?: 'parse'; studio_link?: string; } | object | { result: object | object; usage: parse_usage; response_type?: 'split'; } | { document_url: string; form_schema?: edit_widget[]; response_type?: 'edit'; usage?: parse_usage; } | { job_id: string; result: object; usage: parse_usage; response_type?: 'pipeline'; } | object | { job_id: string; result: object; duration?: number; response_confidence?: object; response_type?: 'classify'; usage?: object; }; } | { status: 'Pending' | 'Completed' | 'Failed' | 'Idle'; bucket?: object; created_at?: string; duration?: number; num_pages?: number; progress?: number; raw_config?: string; reason?: string; result?: { duration: number; job_id: string; result: object | object; usage: parse_usage; parse_mode?: 'base' | 'lite'; pdf_url?: string; response_type?: 'parse'; studio_link?: string; } | object | { result: object | object; usage: parse_usage; response_type?: 'split'; } | { document_url: string; form_schema?: edit_widget[]; response_type?: 'edit'; usage?: parse_usage; } | { job_id: string; result: object; usage: parse_usage; response_type?: 'pipeline'; } | object | { job_id: string; result: object; duration?: number; response_confidence?: object; response_type?: 'classify'; usage?: object; }; source?: object; total_pages?: number; type?: 'Parse' | 'Extract' | 'Split' | 'Edit' | 'Pipeline' | 'Classify'; }`\n\n### Example\n\n```typescript\nimport Reducto from 'reductoai';\n\nconst client = new Reducto();\n\nconst job = await client.job.get('job_id');\n\nconsole.log(job);\n```",
  },
  {
    name: 'get_all',
    endpoint: '/jobs',
