...
import { Reducto, ClientOptions } from 'reductoai';
...
function getTSDiagnostics(code: string): string[] {
  ...
  const codeWithImport = [
    ...
    functionSource.type === 'declaration' ?
      `async function run(${functionSource.client}: Reducto)`
    : `const run: (${functionSource.client}: Reducto) => Promise<unknown> =`,
    functionSource.code,
  ].join('\n');
...
const fuse = new Fuse(
  [
    ...
    'client.parse.runJob',
    'client.extract.run',
    'client.extract.runJob',
    'client.split.run',
    'client.split.runJob',
    'client.edit.run',
    'client.edit.runJob',
    'client.pipeline.run',
    'client.pipeline.runJob',
    'client.classify.run',
    'client.webhook.run',
    'client.job.cancel',
    'client.job.get',
